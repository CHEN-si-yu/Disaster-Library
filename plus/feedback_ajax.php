...
<div class="l_post ">
	...
	<div class="d_post_content_main ">
		...
		<div class="louzhubiaoshi_wrap">
				<div class="louzhubiaoshi" author="<?php echo $username; ?>"></div>
				</div>
									<cc><div id="post_content_18275507649" class="d_post_content"><?php echo ubb($msg); ?></div></cc><br/>
											  	</div>	
	  								<div class="core_reply j_lzl_wrapper">
				<a name="18275507649l"></a>
						    	<div class="core_reply_tail">
	              	                <div class="j_lzl_r p_reply" data-field='{"pid":"18275507649","total_num":""}'>
	                  <a href="#" class="lzl_link_unfold" style="display:;"><?php echo GetDateMk($dtime); ?></a>
...
function GetList($page=1)
{
    ...
    $querystring = "SELECT fb.*,mb.userid,mb.face as mface,mb.spacesta,mb.scores,mb.sex FROM `#@__feedback` fb
                 LEFT JOIN `#@__member` mb on mb.mid = fb.mid WHERE fb.aid='$aid' AND fb.ischeck='1' ORDER BY fb.id";
	...
	<div class="d_post_content_main ">
		...
		<div class="louzhubiaoshi_wrap">
				...
				<a name="18275507649l"></a>
						    	<div class="core_reply_tail">
	              	                <div class="j_lzl_r p_reply" data-field='{"pid":"18275507649","total_num":""}'>
	                  <a href="#" class="lzl_link_unfold" style="display:;"><?php echo GetDateTimeMK($dtime); ?></a>
